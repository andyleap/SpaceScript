...
namespace ScriptLCD.SpaceScript.Types
{
    public class Block : IType, IFields
    {
        ...
        public IType GetField(Scope scope, State state, string name)
        {
			...
			if(name == "DetailedInfo")
			{
				return new String(block.DetailedInfo);
			}
			if(name == "Action")
			{
				return new NativeFunction(args =>
				{
					...
					{
						throw new Exception("Block.Action expects a string");
					}
					var thisaction = block.GetActionWithName(name);
					if(thisaction == null)
					{
						throw new Exception("Action does not exist");
					}
					return new NativeFunction((subargs) =>
					{
						thisaction.Apply(block);
			...
			if (block is SpaceEngineers.Game.ModAPI.Ingame.IMyLandingGear)
			{
				...
				System.Exception: Missing Type: VRage.ModAPI.IMyEntity
				   at InterfaceGenerator.InterfaceGeneratorMain.MatchType(Type t) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 231
				   at InterfaceGenerator.InterfaceGeneratorMain.DumpReader(Type t, StreamWriter code) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 125
				*/
				if (name == "BreakForce")
				{
			...
			if (block is Sandbox.ModAPI.Ingame.IMyLaserAntenna)
			{
				...
				System.Exception: Missing Type: VRageMath.Vector3D
				   at InterfaceGenerator.InterfaceGeneratorMain.MatchType(Type t) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 231
				   at InterfaceGenerator.InterfaceGeneratorMain.DumpReader(Type t, StreamWriter code) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 132
				*/
				if (name == "IsPermanent")
				{
			...
			if (block is Sandbox.ModAPI.Ingame.IMyLargeTurretBase)
			{
				...
				System.Exception: Missing Type: VRage.ModAPI.IMyEntity
				   at InterfaceGenerator.InterfaceGeneratorMain.MatchType(Type t) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 231
				   at InterfaceGenerator.InterfaceGeneratorMain.DumpReader(Type t, StreamWriter code) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 105
				*/
				/*
					if(name == "TrackTarget")
					{
			...
			if (block is Sandbox.ModAPI.IMyFunctionalBlock)
			{
				var b = block as Sandbox.ModAPI.IMyFunctionalBlock;
				if (name == "EnabledChanged")
				{
					return new NativeFunction(args => {
						if (args.Count != 1 || !(args[0] is IInvoke)) { throw new Exception("Event EnabledChanged expects 1 invokable argument"); }
						Action<Sandbox.ModAPI.Ingame.IMyTerminalBlock> handler = (arg1) => {
							List<IType> eventargs = new List<IType>();
							eventargs.Add(new Block(arg1));
							state.scheduler.Threads.Add(new Thread(args[0] as IInvoke, eventargs));
						};
						b.EnabledChanged += handler;
						state.EventHandlerRemovers.Add(() => b.EnabledChanged -= handler);
						return new Bool(true);
					});
				}
			}
			if (block is Sandbox.ModAPI.IMyGyro)
			{
				var b = block as Sandbox.ModAPI.IMyGyro;
				if (name == "GyroStrengthMultiplier")
				{
					return new Float(b.GyroStrengthMultiplier);
				}
				if (name == "PowerConsumptionMultiplier")
				{
					return new Float(b.PowerConsumptionMultiplier);
				}
			}
			if (block is Sandbox.ModAPI.IMyLaserAntenna)
			{
				var b = block as Sandbox.ModAPI.IMyLaserAntenna;
				if (name == "RequireLoS")
				{
					return new Bool(b.RequireLoS);
				}
			}
			if (block is Sandbox.ModAPI.IMyDoor)
			{
				var b = block as Sandbox.ModAPI.IMyDoor;
				if (name == "DoorStateChanged")
				{
					return new NativeFunction(args => {
						if (args.Count != 1 || !(args[0] is IInvoke)) { throw new Exception("Event DoorStateChanged expects 1 invokable argument"); }
						Action<bool> handler = (arg1) => {
							List<IType> eventargs = new List<IType>();
							eventargs.Add(new Bool(arg1));
							state.scheduler.Threads.Add(new Thread(args[0] as IInvoke, eventargs));
						};
						b.DoorStateChanged += handler;
						state.EventHandlerRemovers.Add(() => b.DoorStateChanged -= handler);
						return new Bool(true);
					});
				}
			}
			if (block is Sandbox.ModAPI.IMyMotorBase)
			{
				var b = block as Sandbox.ModAPI.IMyMotorBase;
				/*
					if(name == "Attach")
					{
						return new NativeFunction(args => {
							if(args.Count != 1){throw new Exception("Attach expects 1 parameters");}
				System.Exception: Missing Type: Sandbox.ModAPI.IMyMotorRotor
				   at InterfaceGenerator.InterfaceGeneratorMain.MatchType(Type t) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 231
				   at InterfaceGenerator.InterfaceGeneratorMain.DumpReader(Type t, StreamWriter code) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 105
				*/
				/*
					if(name == "RotorGrid")
					{
				System.Exception: Missing Type: VRage.Game.ModAPI.IMyCubeGrid
				   at InterfaceGenerator.InterfaceGeneratorMain.MatchType(Type t) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 231
				   at InterfaceGenerator.InterfaceGeneratorMain.DumpReader(Type t, StreamWriter code) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 132
				*/
				/*
					if(name == "Rotor")
					{
				System.Exception: Missing Type: VRage.Game.ModAPI.IMyCubeBlock
				   at InterfaceGenerator.InterfaceGeneratorMain.MatchType(Type t) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 231
				   at InterfaceGenerator.InterfaceGeneratorMain.DumpReader(Type t, StreamWriter code) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 132
				*/
				/*
					if(name == "DummyPosition")
					{
				System.Exception: Missing Type: VRageMath.Vector3
				   at InterfaceGenerator.InterfaceGeneratorMain.MatchType(Type t) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 231
				   at InterfaceGenerator.InterfaceGeneratorMain.DumpReader(Type t, StreamWriter code) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 132
				*/
				if (name == "AttachedEntityChanged")
				{
					return new NativeFunction(args => {
						if (args.Count != 1 || !(args[0] is IInvoke)) { throw new Exception("Event AttachedEntityChanged expects 1 invokable argument"); }
						Action<Sandbox.ModAPI.Ingame.IMyTerminalBlock> handler = (arg1) => {
							List<IType> eventargs = new List<IType>();
							eventargs.Add(new Block(arg1));
							state.scheduler.Threads.Add(new Thread(args[0] as IInvoke, eventargs));
						};
						b.AttachedEntityChanged += handler;
						state.EventHandlerRemovers.Add(() => b.AttachedEntityChanged -= handler);
						return new Bool(true);
					});
				}
			}
			if (block is Sandbox.ModAPI.IMyMotorStator)
			{
				var b = block as Sandbox.ModAPI.IMyMotorStator;
				if (name == "LimitReached")
				{
					return new NativeFunction(args => {
						if (args.Count != 1 || !(args[0] is IInvoke)) { throw new Exception("Event LimitReached expects 1 invokable argument"); }
						Action<bool> handler = (arg1) => {
							List<IType> eventargs = new List<IType>();
							eventargs.Add(new Bool(arg1));
							state.scheduler.Threads.Add(new Thread(args[0] as IInvoke, eventargs));
						};
						b.LimitReached += handler;
						state.EventHandlerRemovers.Add(() => b.LimitReached -= handler);
						return new Bool(true);
					});
				}
			}
			if (block is Sandbox.ModAPI.IMyOxygenGenerator)
			{
				var b = block as Sandbox.ModAPI.IMyOxygenGenerator;
				if (name == "ProductionCapacityMultiplier")
				{
					return new Float(b.ProductionCapacityMultiplier);
				}
				if (name == "PowerConsumptionMultiplier")
				{
					return new Float(b.PowerConsumptionMultiplier);
			...
			if (block is Sandbox.ModAPI.IMyPistonBase)
			{
				var b = block as Sandbox.ModAPI.IMyPistonBase;
				/*
					if(name == "Attach")
					{
						return new NativeFunction(args => {
							if(args.Count != 1){throw new Exception("Attach expects 1 parameters");}
				System.Exception: Missing Type: Sandbox.ModAPI.IMyPistonTop
				   at InterfaceGenerator.InterfaceGeneratorMain.MatchType(Type t) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 231
				   at InterfaceGenerator.InterfaceGeneratorMain.DumpReader(Type t, StreamWriter code) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 105
				*/
				/*
			...
			if (block is Sandbox.ModAPI.IMyProductionBlock)
			{
				var b = block as Sandbox.ModAPI.IMyProductionBlock;
				/*
					if(name == "StartedProducing")
					{
						return new NativeFunction(args => {
							if(args.Count != 1 || !(args[0] is IInvoke)){ throw new Exception("Event StartedProducing expects 1 invokable argument"); }
				System.InvalidOperationException: This operation is only valid on generic types.
				   ...
				   at InterfaceGenerator.InterfaceGeneratorMain.MakeAction(Type t) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 235
				   at InterfaceGenerator.InterfaceGeneratorMain.DumpReader(Type t, StreamWriter code) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 139
				*/
				/*
					if(name == "StoppedProducing")
					{
						return new NativeFunction(args => {
							if(args.Count != 1 || !(args[0] is IInvoke)){ throw new Exception("Event StoppedProducing expects 1 invokable argument"); }
				System.InvalidOperationException: This operation is only valid on generic types.
				   at System.RuntimeType.GetGenericTypeDefinition()
				   at InterfaceGenerator.InterfaceGeneratorMain.MakeAction(Type t) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 235
				   at InterfaceGenerator.InterfaceGeneratorMain.DumpReader(Type t, StreamWriter code) in C:\Users\andrew.leap\Documents\Visual Studio 2015\Projects\InterfaceGenerator\InterfaceGenerator\Class1.cs:line 139
			...
			if (block is Sandbox.ModAPI.IMyReactor)
			{
				var b = block as Sandbox.ModAPI.IMyReactor;
				if (name == "PowerOutputMultiplier")
				{
					return new Float(b.PowerOutputMultiplier);
				}
			}
			if (block is Sandbox.ModAPI.IMySensorBlock)
			{
				var b = block as Sandbox.ModAPI.IMySensorBlock;
				if (name == "StateChanged")
				{
					return new NativeFunction(args => {
						if (args.Count != 1 || !(args[0] is IInvoke)) { throw new Exception("Event StateChanged expects 1 invokable argument"); }
						Action<bool> handler = (arg1) => {
							List<IType> eventargs = new List<IType>();
							eventargs.Add(new Bool(arg1));
							state.scheduler.Threads.Add(new Thread(args[0] as IInvoke, eventargs));
						...
						state.EventHandlerRemovers.Add(() => b.StateChanged -= handler);
						return new Bool(true);
					});
				}
			}
			if (block is Sandbox.ModAPI.IMyShipDrill)
			{
				var b = block as Sandbox.ModAPI.IMyShipDrill;
				if (name == "DrillHarvestMultiplier")
				{
					return new Float(b.DrillHarvestMultiplier);
				}
				if (name == "PowerConsumptionMultiplier")
				{
					return new Float(b.PowerConsumptionMultiplier);
			...
			if (block is Sandbox.ModAPI.IMyShipWelder)
			{
				var b = block as Sandbox.ModAPI.IMyShipWelder;
			}
			if (block is Sandbox.ModAPI.IMyThrust)
			{
				var b = block as Sandbox.ModAPI.IMyThrust;
				if (name == "ThrustMultiplier")
				{
					return new Float(b.ThrustMultiplier);
				}
				if (name == "PowerConsumptionMultiplier")
				{
					return new Float(b.PowerConsumptionMultiplier);
			...
			if (block is Sandbox.ModAPI.IMyMotorSuspension)
			{
				var b = block as Sandbox.ModAPI.IMyMotorSuspension;
			}
			if (block is Sandbox.ModAPI.IMyTextPanel)
			{
				var b = block as Sandbox.ModAPI.IMyTextPanel;
			}
			#endregion
		...
		public void SetField(Scope scope, State state, string name, IType value)
        {
			...
			if (block is Sandbox.ModAPI.Ingame.IMyBatteryBlock)
			{
				...
				if (name == "OnlyRecharge")
				{
					b.OnlyRecharge = value.Cast<Bool>().Value;
				}
				if (name == "OnlyDischarge")
				{
					b.OnlyDischarge = value.Cast<Bool>().Value;
				}
				if (name == "SemiautoEnabled")
				{
					b.SemiautoEnabled = value.Cast<Bool>().Value;
				}
			}
			if (block is Sandbox.ModAPI.Ingame.IMyBeacon)
			{
			...
			if (block is Sandbox.ModAPI.Ingame.IMyLargeTurretBase)
			{
				...
				if (name == "Elevation")
				{
					b.Elevation = value.Cast<Float>().Value;
				}
				if (name == "Azimuth")
				{
					b.Azimuth = value.Cast<Float>().Value;
				}
				if (name == "EnableIdleRotation")
				{
					b.EnableIdleRotation = value.Cast<Bool>().Value;
				}
			}
			if (block is Sandbox.ModAPI.Ingame.IMyLightingBlock)
			{
			...
			if (block is Sandbox.ModAPI.IMyGyro)
			{
				...
				if (name == "GyroStrengthMultiplier")
				{
					b.GyroStrengthMultiplier = value.Cast<Float>().Value;
				}
				if (name == "PowerConsumptionMultiplier")
				{
					b.PowerConsumptionMultiplier = value.Cast<Float>().Value;
				}
			}
			if (block is Sandbox.ModAPI.IMyLaserAntenna)
			{
			...
			if (block is Sandbox.ModAPI.IMyOxygenGenerator)
			{
				...
				if (name == "ProductionCapacityMultiplier")
				{
					b.ProductionCapacityMultiplier = value.Cast<Float>().Value;
				}
				if (name == "PowerConsumptionMultiplier")
				{
					b.PowerConsumptionMultiplier = value.Cast<Float>().Value;
			...
			if (block is Sandbox.ModAPI.IMyReactor)
			{
				...
				if (name == "PowerOutputMultiplier")
				{
					b.PowerOutputMultiplier = value.Cast<Float>().Value;
				}
			}
			if (block is Sandbox.ModAPI.IMySensorBlock)
			{
			...
			if (block is Sandbox.ModAPI.IMyShipDrill)
			{
				...
				if (name == "DrillHarvestMultiplier")
				{
					b.DrillHarvestMultiplier = value.Cast<Float>().Value;
				}
				if (name == "PowerConsumptionMultiplier")
				{
					b.PowerConsumptionMultiplier = value.Cast<Float>().Value;
			...
			if (block is Sandbox.ModAPI.IMyThrust)
			{
				...
				if (name == "ThrustMultiplier")
				{
					b.ThrustMultiplier = value.Cast<Float>().Value;
				}
				if (name == "PowerConsumptionMultiplier")
				{
					b.PowerConsumptionMultiplier = value.Cast<Float>().Value;
